...
def main(argv):
	...
	secondsImage = secondsImage.rotate(-360.0 * (time.second / 60.0), Image.NEAREST)
	hoursImage = hoursImage.rotate(-360.0 * ((time.hour % 12) * 60 + time.minute) / (12.0 * 60.0), Image.NEAREST)
	minutesImage = minutesImage.rotate(-360.0 * (time.minute / 60.0), Image.NEAREST)
